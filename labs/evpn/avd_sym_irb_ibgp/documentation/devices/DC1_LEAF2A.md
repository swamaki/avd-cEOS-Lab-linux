...
| Ethernet5 | server03_Eth1 | *trunk | *112 | *- | *- | 5 |
| Ethernet6 | server04_Eth1 | *trunk | *113 | *- | *- | 6 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 192.168.255.5 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | enabled | 12000 | disabled | disabled | - | - | - | - |
