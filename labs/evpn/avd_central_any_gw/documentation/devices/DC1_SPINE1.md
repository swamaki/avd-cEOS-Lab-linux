...
| Ethernet4 | P2P_LINK_TO_DC1_SVC1A_Ethernet1 | routed | - | 172.31.255.12/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_DC1_SVC1B_Ethernet1 | routed | - | 172.31.255.16/31 | default | 9214 | False | - | - |
...
| 172.31.255.13 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.255.6 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
