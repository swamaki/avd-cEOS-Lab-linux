...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | server03_Eth1 | *trunk | *110 | *- | *- | 3 |
| Ethernet4 | server03_Eth2 | *trunk | *110 | *- | *- | 3 |
| Ethernet5 | server04_Eth1 | *trunk | *111 | *- | *- | 5 |
| Ethernet6 | server04_Eth2 | *trunk | *111 | *- | *- | 5 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | server03_PortChannel3 | switched | trunk | 110 | - | - | - | - | - | - |
| Port-Channel5 | server04_PortChannel6 | switched | trunk | 111 | - | - | - | - | - | - |
