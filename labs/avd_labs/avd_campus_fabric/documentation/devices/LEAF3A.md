...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.16.2.104/24 | 172.16.2.1 |
...
| --------- | --------------- | ------------ | --------- |
| IDF3_AGG | Vlan4094 | 192.168.0.11 | Port-Channel23 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SPINE1_Ethernet3 | *trunk | *10,310,320,330 | *- | *- | 1 |
| Ethernet2 | SPINE2_Ethernet3 | *trunk | *10,310,320,330 | *- | *- | 1 |
| Ethernet3 | LEAF3C_Ethernet1 | *trunk | *10,310,320,330 | *- | *- | 3 |
| Ethernet4 | LEAF3D_Ethernet1 | *trunk | *10,310,320,330 | *- | *- | 4 |
| Ethernet5 | LEAF3E_Ethernet1 | *trunk | *10,310,320,330 | *- | *- | 5 |
...
| Ethernet23 | MLAG_PEER_LEAF3B_Ethernet23 | *trunk | *- | *- | *['MLAG'] | 23 |
| Ethernet24 | MLAG_PEER_LEAF3B_Ethernet24 | *trunk | *- | *- | *['MLAG'] | 23 |
...
!
interface Ethernet3
   description LEAF3C_Ethernet1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description LEAF3D_Ethernet1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description LEAF3E_Ethernet1
   no shutdown
...
interface Ethernet23
   description MLAG_PEER_LEAF3B_Ethernet23
   no shutdown
   channel-group 23 mode active
!
interface Ethernet24
   description MLAG_PEER_LEAF3B_Ethernet24
   no shutdown
   channel-group 23 mode active
```
...
| Port-Channel23 | MLAG_PEER_LEAF3B_Po23 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel23
   description MLAG_PEER_LEAF3B_Po23
   no shutdown
   switchport
   switchport mode trunk
