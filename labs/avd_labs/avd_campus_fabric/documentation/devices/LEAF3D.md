...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.16.2.107/24 | 172.16.2.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | LEAF3A_Ethernet4 | *trunk | *10,310,320,330 | *- | *- | 1 |
| Ethernet2 | LEAF3B_Ethernet4 | *trunk | *10,310,320,330 | *- | *- | 1 |
...
!
interface Ethernet1
   description LEAF3A_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description LEAF3B_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet6
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | IDF3_AGG_Po4 | switched | trunk | 10,310,320,330 | - | - | - | - | - | - |
