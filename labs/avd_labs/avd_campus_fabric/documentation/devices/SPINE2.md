...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.0.0 | Port-Channel23 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | LEAF1B_Ethernet1 | *trunk | *10,110,120,130 | *- | *- | 1 |
| Ethernet2 | LEAF2A_Ethernet2 | *trunk | *10,210,220,230 | *- | *- | 2 |
| Ethernet3 | LEAF3A_Ethernet2 | *trunk | *10,310,320,330 | *- | *- | 3 |
| Ethernet4 | LEAF3B_Ethernet2 | *trunk | *10,310,320,330 | *- | *- | 3 |
| Ethernet23 | MLAG_PEER_SPINE1_Ethernet23 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 23 |
| Ethernet24 | MLAG_PEER_SPINE1_Ethernet24 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 23 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_LINK_TO_WAN_Ethernet2 | routed | - | 10.0.0.5/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description LEAF1B_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description LEAF2A_Ethernet2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description LEAF3A_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description LEAF3B_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
interface Ethernet23
   description MLAG_PEER_SPINE1_Ethernet23
   no shutdown
   channel-group 23 mode active
!
interface Ethernet24
   description MLAG_PEER_SPINE1_Ethernet24
   no shutdown
   channel-group 23 mode active
```
...
| Port-Channel23 | MLAG_PEER_SPINE1_Po23 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel23
   description MLAG_PEER_SPINE1_Po23
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 172.26.26.2/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 172.26.26.2 | enabled | Vlan4093 <br> Ethernet5 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
